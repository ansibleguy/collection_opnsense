...
| target_pipe  | string  | false    | -             | pipe                              | Pipe to link to the rule, alternative to 'target_queue'                                                                     |
| target_queue  | string  | false    | -             | queue                             | Pipe to link to the rule, alternative to 'target_pipe'                                                                      |
