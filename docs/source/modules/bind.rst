...
The management of `round-robin <https://en.wikipedia.org/wiki/Round-robin_DNS>`_ records is a harder to manage by the module as a single record cannot be identified!
