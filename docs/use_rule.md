...
| sequence     | int     | false    | 1             | seq                    | Sequence for rule processing                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| protocol     | string  | false    | 'any'         | p, proto               | Protocol like 'TCP', 'UDP', 'TCP/UDP' and so on. For options see the WEB-UI.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| source_invert     | boolean | false    | false         | si, src_inv, src_not   | Inverted matching of the source                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| source_net     | string | false    | 'any'         | s, src                 | Host, network, alias or 'any'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| destination_net     | string | false    | 'any'         | d, dest                | Host, network, alias or 'any'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
