...
def run_module():
    module_args = dict(
        ...
        source_port=dict(type='int', required=False, description='Leave empty to allow all'),
        destination_invert=dict(type='bool', required=False, default=False),
        destination_net=dict(type='str', required=True, description="Host, network or 'any'"),
        destination_port=dict(type='int', required=False, description='Leave empty to allow all'),
