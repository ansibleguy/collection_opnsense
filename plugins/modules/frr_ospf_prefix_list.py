...
try:
    ...
    from ansible_collections.ansibleguy.opnsense.plugins.module_utils.main.frr_ospf_prefix_list import Prefix
...
def run_module():
    ...
    p = Prefix(module=module, result=result)
    ...
    if PROFILE or module.params['debug']:
        profiler(check=process, log_file='frr_ospf_prefix_list.log')
